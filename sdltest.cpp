//from https://www.raspberrypi.org/forums/viewtopic.php?t=13789
//to compile:  gcc -o sdltest this-file.cpp `sdl-config --cflags --libs`
//NOTE: -o must appear before --libs
